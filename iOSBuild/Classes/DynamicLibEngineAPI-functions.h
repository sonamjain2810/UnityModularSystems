...
UnityExternCall(void,               UnityRequestUnload);
...
UnityExternCall(void,             UnitySelectRenderingAPI);
...
UnityExternCall(int,              ParseDeviceGeneration, const char*);
...
UnityExternCall(void,             UnityWebRequestAddCustomHeader, void**, const char*, const char*);
