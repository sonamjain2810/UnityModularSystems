...
namespace Obvious.Soap.Editor
{
    public partial class SoapWizardWindow : EditorWindow
    {
        ...
        private void LoadIcons()
        {
            ...
            _icons[12] = Resources.Load<Texture>("Icons/icon_scriptableDictionary");
        }
        ...
        private void DrawUtilityButtons()
        {
            ...
            var icon = isFavorite ? _icons[9] : _icons[0];
        ...
        private Texture GetIconFor(ScriptableBase scriptableBase)
        {
            ...
            switch (scriptableBase)
            {
                ...
                case ScriptableSaveBase _:
                    iconIndex = 5;
                    break;
                case ScriptableDictionaryBase _:
                    iconIndex = 12;
                    break;
            }
